...
public partial class MainWindow
{
	...
	protected virtual void Build ()
	{
		...
		this.editAction.ShortLabel = global::Mono.Unix.Catalog.GetString ("_Limpiar");
		...
		this.UIManager.AddUiFromString ("<ui><toolbar name='toolbar2'><toolitem name='clearAction' action='clearAction'/><toolitem name='editAction' action='editAction'/></toolbar></ui>");
