...
namespace PArticulo
{
	public partial class ArticuloView
	{
		...
		protected virtual void Build ()
		{
			...
			this.UIManager.AddUiFromString ("<ui><toolbar name='toolbar1'><toolitem/><toolitem name='saveAction1' action='saveAction1'/></toolbar></ui>");
			...
			this.label1.LabelProp = global::Mono.Unix.Catalog.GetString ("Nombrel1");
